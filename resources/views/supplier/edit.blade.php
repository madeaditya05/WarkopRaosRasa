          ...
          <div class="card-body">
            ...
            <form action="{{ route('supplier.update', $supplier->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-solid" id="nama_supplier" name="nama_supplier" type="text" placeholder="Contoh: PR-001" value="{{ $supplier->nama_supplier }}" required>
                </div>

                <div class="mb-3">
                    <label for="kontak">Kontak</label>
                    <input class="form-control form-control-solid" id="kontak" name="kontak" type="number" placeholder="Contoh: 08123456789" value="{{ $supplier->kontak }}">
                </div>
