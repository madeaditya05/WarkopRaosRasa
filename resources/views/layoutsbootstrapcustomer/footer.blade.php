<style>
  ...
  #footer-bottom,
  #footer-bottom a {
    color: rgb(95, 58, 31) !important;
  }

  footer input,
  footer .btn {
    border-color: rgb(95, 58, 31);
  }

  footer .btn {
    background-color: rgb(95, 58, 31);
    color: white;
  }
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="images/logos/warkop.png" alt="logo" style="max-width: 100%; height: auto; width: 200px; margin-left: 20px;">
